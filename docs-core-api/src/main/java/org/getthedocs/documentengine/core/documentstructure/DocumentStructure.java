...
import org.getthedocs.documentengine.core.documentstructure.descriptors.GenerationResultMode;
...
public class DocumentStructure implements JsonModel {
    ...
    /**
     * Sets the output - one/many files (the formats will be checked before
     * generation against the actual converter set)
     */
    ...
    /**
     * Default constructor to initialize the data structure. (By default the
     * transaction id with a random uuid)
     */
    ...
    /**
     * Initializes the container with a pre-defined transaction id. This setup is
     * used in case of active result stores, where the document conatiner name is
     * generated by the storage system, or has to be identical with the enclosing
     ...
     * 
     * @param id      the transaction id to be used during generation.
     * @param version the document structure version.
     */
    public DocumentStructure(final String id, final String version) {
    ...
    /**
     * Returns a template element descriptor within the document structure
    ...
    /**
     * Returns the document generation result's mode - single (concatenated), or
     * separate documents.
     * 
     ...
     * 
     * @param resultMode result's mode - single (concatenated), or separate
     *                   documents.
     */
    ...
    /**
     * Returns a template element defined by the document structure, selected by its
     * friendly name.
     * 
    ...
    public String toString() {
        return "DocumentStructure{" + "documentStructureId='" + documentStructureId + '\'' + ", version=" + version
                + ", elements=" + elements + ", resultMode=" + resultMode + ", outputFormat=" + outputFormat
                + ", copies=" + copies + '}';
    }
}

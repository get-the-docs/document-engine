...
import net.videki.documentengine.api.document.api.model.GetDocumentStructuresResponse;
...
public interface GetDocumentStructuresResponseApiModelMapper {
	...
	default GetDocumentStructuresResponse pageToApiModel(
			net.videki.documentengine.core.provider.persistence.Page<DocumentStructure> source) {
		...
		result.setContents(
				new ArrayList<net.videki.documentengine.api.document.api.model.DocumentStructure>(source.getData().stream()

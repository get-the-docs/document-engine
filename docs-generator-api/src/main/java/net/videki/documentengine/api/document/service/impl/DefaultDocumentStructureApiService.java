package net.videki.documentengine.api.document.service.impl;
...
import net.videki.documentengine.api.document.model.ValueSetItem;
...
import net.videki.documentengine.core.documentstructure.ValueSet;
...
public class DefaultDocumentStructureApiService implements DocumentStructureApiService {
    ...
    private ValueSet getValueSet(final Object data) {
        if (data instanceof Map) {
            ...
            final var param = (net.videki.documentengine.api.document.model.ValueSet) data;

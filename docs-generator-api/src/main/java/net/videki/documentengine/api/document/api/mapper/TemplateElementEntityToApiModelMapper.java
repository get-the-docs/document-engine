...
public interface TemplateElementEntityToApiModelMapper {
	 ...
	 */
	default net.videki.documentengine.api.document.api.model.TemplateElement entityToApiModel(
			TemplateElement source) {

		if (source != null) {
			final net.videki.documentengine.api.document.api.model.TemplateElement target = new net.videki.documentengine.api.document.api.model.TemplateElement();
			...
			if (source.getFormat() != null) {
				target.setInputFormat(net.videki.documentengine.api.document.api.model.TemplateElement.InputFormatEnum
	 ...
	 */
	List<net.videki.documentengine.api.document.api.model.TemplateElement> entityListToApiModelList(
	 ...
	 */
	default List<net.videki.documentengine.api.document.api.model.TemplateNameItem> mapTemplateNames(
			Map<Locale, String> value) {

		final List<net.videki.documentengine.api.document.api.model.TemplateNameItem> results = new ArrayList<>(
				value.keySet().size());

		if (value != null) {
			for (final Locale actValue : value.keySet()) {
				final net.videki.documentengine.api.document.api.model.TemplateNameItem actItem = new net.videki.documentengine.api.document.api.model.TemplateNameItem();

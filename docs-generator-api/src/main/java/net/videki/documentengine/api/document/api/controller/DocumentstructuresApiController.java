...
import net.videki.documentengine.api.document.api.mapper.GetDocumentStructuresResponseApiModelMapper;
import net.videki.documentengine.api.document.api.model.*;
import net.videki.documentengine.api.document.service.DocumentStructureApiService;

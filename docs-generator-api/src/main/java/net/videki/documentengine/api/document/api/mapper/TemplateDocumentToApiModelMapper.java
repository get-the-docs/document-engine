...
import net.videki.documentengine.api.document.api.model.GetTemplatesResponse;
import net.videki.documentengine.api.document.api.model.Page;
...
public interface TemplateDocumentToApiModelMapper {
	...
	net.videki.documentengine.api.document.api.model.TemplateDocument entityToApiModel(TemplateDocument source);
	 ...
	 */
	List<net.videki.documentengine.api.document.api.model.TemplateDocument> entityListToApiModelList(List<TemplateDocument> source);
	 ...
	 */
	default GetTemplatesResponse pageToApiModel(net.videki.documentengine.core.provider.persistence.Page<TemplateDocument> source) {
		...
		result.setContents(new ArrayList<net.videki.documentengine.api.document.api.model.TemplateDocument>(source.getData().stream().map(INSTANCE::entityToApiModel).collect(Collectors.toList())));

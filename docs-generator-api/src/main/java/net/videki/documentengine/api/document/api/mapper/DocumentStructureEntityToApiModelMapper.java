...
public interface DocumentStructureEntityToApiModelMapper {
	 ...
	 */
	default net.videki.documentengine.api.document.api.model.DocumentStructure entityToApiModel(
			DocumentStructure source) {

			if (source != null) {
				final net.videki.documentengine.api.document.api.model.DocumentStructure target = new net.videki.documentengine.api.document.api.model.DocumentStructure();

				target.setDocumentStructureId(source.getDocumentStructureId());
				if (source.getResultMode() != null) {
					target.setResultMode(net.videki.documentengine.api.document.api.model.DocumentStructure.ResultModeEnum.valueOf(source.getResultMode().name()));
				}
	 ...
	 */
	List<net.videki.documentengine.api.document.api.model.DocumentStructure> entityListToApiModelList(

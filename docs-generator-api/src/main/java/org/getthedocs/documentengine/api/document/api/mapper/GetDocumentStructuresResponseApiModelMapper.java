...
import org.getthedocs.documentengine.api.document.api.model.GetDocumentStructuresResponse;
...
public interface GetDocumentStructuresResponseApiModelMapper {
	...
	default GetDocumentStructuresResponse pageToApiModel(
			org.getthedocs.documentengine.core.provider.persistence.Page<DocumentStructure> source) {
		...
		result.setContents(
				new ArrayList<org.getthedocs.documentengine.api.document.api.model.DocumentStructure>(source.getData().stream()

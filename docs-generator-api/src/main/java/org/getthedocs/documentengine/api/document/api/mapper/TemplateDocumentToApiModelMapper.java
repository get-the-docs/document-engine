...
public interface TemplateDocumentToApiModelMapper {
	...
	org.getthedocs.documentengine.api.document.api.model.TemplateDocument entityToApiModel(TemplateDocument source);
	 ...
	 */
	List<org.getthedocs.documentengine.api.document.api.model.TemplateDocument> entityListToApiModelList(List<TemplateDocument> source);
	...
	default GetTemplatesResponse pageToApiModel(org.getthedocs.documentengine.core.provider.persistence.Page<TemplateDocument> source) {
		...
		result.setContents(new ArrayList<org.getthedocs.documentengine.api.document.api.model.TemplateDocument>(source.getData().stream().map(INSTANCE::entityToApiModel).collect(Collectors.toList())));

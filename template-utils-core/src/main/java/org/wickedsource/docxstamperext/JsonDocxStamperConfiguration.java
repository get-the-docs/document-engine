...
public class JsonDocxStamperConfiguration extends DocxStamperConfiguration{
     ...
     */
    public JsonDocxStamperConfiguration setLineBreakPlaceholder(String lineBreakPlaceholder) {

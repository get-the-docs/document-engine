...
public interface TemplateElementEntityToApiModelMapper {
	...
	default net.videki.templateutils.api.document.api.model.TemplateElement entityToApiModel(
		...
		if (source != null) {
			...
			if (source.getFormat() != null) {
				target.setInputFormat(net.videki.templateutils.api.document.api.model.TemplateElement.InputFormatEnum
	 ...
	 */
	default List<net.videki.templateutils.api.document.api.model.TemplateNameItem> mapTemplateNames(

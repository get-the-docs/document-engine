...
ENTRYPOINT ["java","-Dspring.profiles.active=prod", "-Dconfig=\"/app/config\"", "-Dloader.path=\"/app/config\"","--add-opens","java.base/java.lang=ALL-UNNAMED","--add-opens", "java.base/java.lang.reflect=ALL-UNNAMED","--add-opens", "java.base/java.io=ALL-UNNAMED","--add-opens", "java.base/java.time=ALL-UNNAMED","--add-exports", "java.base/sun.nio.ch=ALL-UNNAMED","--add-exports", "jdk.unsupported/sun.misc=ALL-UNNAMED", "-cp","/app/app.jar:/app/config","org.springframework.boot.loader.PropertiesLauncher"]
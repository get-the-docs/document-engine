package net.videki.documentengine.documentstructure.builder.core.documentstructure.repository.filesystem;
...
import net.videki.documentengine.core.provider.documentstructure.repository.ConfigurableDocumentStructureRepository;
